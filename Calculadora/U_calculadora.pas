...
type
  ...
  private
    ...
    Foperacao : Char;
    Ftotal : Double; //guardar  valor total da opreção (numero com virgula)
...
begin
  FUltimoNumero := StrToFloat(Edt_Resultado.text);
    Calcular;
  Foperacao := '+'; //Alimentar a variavel Operação com o valor +
...
begin
   case FOperacao of
    '+' :  Ftotal := Ftotal + StrToFloat (Edt_Resultado.Text);  //valor total receberá o valor que está la mais o que vai ser digitado.
